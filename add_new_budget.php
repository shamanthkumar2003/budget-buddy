...
<div class='sub_main_rounded'>
    <div style='display:flex; '>
        <h2 style='margin-right: auto;'>Add New Budget</h2>
    </div>
    <hr>
...
<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = mysqli_prepare($conn, "INSERT INTO budget_management (category, description, amount, datecreated) VALUES (?, ?, ?, ?)");
        ...
        if ($rowsAffected > 0) {
            ...
            echo'
            <script>
            alert("An Error Occurred. No New Budget Created");
            </script>';
        }
        mysqli_close($conn);
    }
