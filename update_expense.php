...
if (isset($_GET['id'])) {
    ...
    $query = mysqli_prepare($conn, "SELECT * FROM expense_management WHERE id = ? ");
...
<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $amount = $_POST["amount"];
        $query = mysqli_prepare($conn, "UPDATE expense_management SET category = ?, description = ? , amount = ? WHERE id = ?;");
